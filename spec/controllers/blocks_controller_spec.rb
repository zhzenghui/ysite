...
describe BlocksController do
  ...
  let(:valid_attributes) { { "block_type_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved block as @block" do
        ...
        post :create, {:block => { "block_type_id" => "invalid value" }}, valid_session
        assigns(:block).should be_a_new(Block)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested block" do
        ...
        Block.any_instance.should_receive(:update).with({ "block_type_id" => "1" })
        put :update, {:id => block.to_param, :block => { "block_type_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the block as @block" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Block.any_instance.stub(:save).and_return(false)
        put :update, {:id => block.to_param, :block => { "block_type_id" => "invalid value" }}, valid_session
        assigns(:block).should eq(block)
      end
